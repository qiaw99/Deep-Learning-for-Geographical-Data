...
class ISPRSDatasetConfig(object):
    def __init__(self):
#        self.num_class = 10
        self.num_class = 1
...
#        self.type2onehotclass={'bed':0, 'table':1, 'sofa':2, 'chair':3, 'toilet':4, 'desk':5, 'dresser':6, 'night_stand':7, 'bookshelf':8, 'bathtub':9}
        self.type2onehotclass={'building':0}
...
#                          'toilet': np.array([0.699104,0.454178,0.756250])}
        self.type_mean_size = {'building': np.array([9.0629241 , 5.83645853, 4.26936354])}
